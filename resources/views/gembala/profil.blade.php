...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    ...
    {{-- Header Card dengan Gradien Indigo --}}
    <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-8 text-center relative">
        {{-- Pattern --}}
        ...
        <p class="text-sm text-indigo-100 mt-1 flex items-center justify-center gap-1">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {{-- Form Edit --}}
    <div class="p-6">
        <form action="{{ route('gembala.profil.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
