...
<head>
    ...
    <title>@yield('title') — Pelayan GPdI Shekinah</title>
    ...
    <aside id="sidebar"
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b border-blue-700">
            ...
            <a href="{{ route('beranda') }}" class="flex items-center gap-3 flex-shrink-0 logo-full">
                ...
                <div class="leading-tight">
                    ...
                    <p class="text-xs text-blue-200 font-normal">Panel Pelayan</p>
                </div>
            </a>
        ...
        <nav class="flex-1 px-2 py-4 space-y-0.5 overflow-y-auto">
            ...
            <a href="{{ route('pelayan.dashboard') }}"
               ...
               {{ request()->routeIs('pelayan.dashboard') ? 'text-white bg-blue-700' : 'text-blue-100 hover:text-white hover:bg-blue-700' }}">
            ...
            <a href="{{ route('pelayan.jadwal') }}"
               class="menu-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
               {{ request()->routeIs('pelayan.jadwal') ? 'text-white bg-blue-700' : 'text-blue-100 hover:text-white hover:bg-blue-700' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
                <span class="sidebar-text sidebar-label">Jadwal Saya</span>
            </a>

            <a href="{{ route('pelayan.tukar-jadwal') }}"
               class="menu-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
               {{ request()->routeIs('pelayan.tukar-jadwal*') ? 'text-white bg-blue-700' : 'text-blue-100 hover:text-white hover:bg-blue-700' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="sidebar-text sidebar-label">Tukar Jadwal</span>
            </a>
            ...
            <a href="{{ route('pelayan.profil') }}"
               class="menu-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
               {{ request()->routeIs('pelayan.profil*') ? 'text-white bg-blue-700' : 'text-blue-100 hover:text-white hover:bg-blue-700' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border-t border-blue-700 px-3 py-3">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div class="flex-1 min-w-0 user-info-text">
                    ...
                    <p class="text-xs text-blue-200 truncate">Pelayan</p>
                </div>
            </div>
